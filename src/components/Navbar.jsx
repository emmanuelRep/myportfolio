  ...
  return (
    ...
    bg-primary`} >
        <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
          ...
          >
            <img src={Apex} alt="logo" className='w-9 h-9 object-contain flex-grow'/>
                <p className='text-white text-[18px] font-bold cursor-pointer ml-4 flex'>
                  Emmanuel &nbsp; 
                  <span className='sm:block hidden'>| My Portfolio
                  </span></p>
           </Link>
