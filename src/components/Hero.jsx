            ...
            <div className="w-1 sm:h-80 h-40 violet-gradient"/>
                ...
                <div>
                  <h1 className={`font-black text-white lg:text-[80px] sm:text-[60px] xs:text-[50px] text-[40px] lg:leading-[98px] mt-2 text-white`}>
                    ...
                    I design accessible user interfaces and web applications <br
                    className="sm:block hidden"/> that empower individuals to engage with cutting-edge digital experiences. 
                    </p>
